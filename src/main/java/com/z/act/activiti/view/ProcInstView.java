...
import com.z.act.activiti.controller.ProcinstController;
...
public class ProcInstView {
     ...
     * @return
     */
    @RequestMapping("procinst/delete")
     ...
     * @return
     */
    @RequestMapping("procinst/modelpng")
    public void model(String procinstId, String procdefId, HttpServletResponse response) throws IOException {
        ...
        InputStream diagram = processDiagramGenerator.generateDiagram(
                bpmnModel,"jpg", executedActivityIdList, executedFlowIdList,"黑体","黑体","黑体",null, 1);
